...
def get_b64_test_image_for_Gill():
...
if __name__ == '__main__':
    ...
    print(classify_image(None, "./test_images/Shubmab-Gill.jpg")) # Inconsistent result could be due to https://github.com/scikit-learn/scikit-learn/issues/13211
